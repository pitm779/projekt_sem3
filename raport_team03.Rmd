...
`r ifelse(nrow(nie_wracaja) == 0, "Nasz program wycieczek jest dobry, bo po każdej klienci wracaja.","Warto zmienić zawartość tych, po których nie wracają klienci, lub kompletnie usunąć je z oferty.") ` 
...
value1 <- value1[-1, ]
value1$col2 <- c("Fabryczna", "Krzyki", "Psie pole", "Sródmiescie", "Stare miasto")
