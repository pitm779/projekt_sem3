...
"
dbExecute(con22, create_query)

query <- "
LOAD DATA LOCAL INFILE 'C:/Users/admin/Desktop/programowanie/sem3/PROJEKT/Adresy_StanNa20250119.csv'
...
"
dbExecute(con22, query)

query_update <- "
UPDATE temp_adresy
SET col1 = REPLACE(col1, 'ul. ', '');
"
dbExecute(con22, query_update)
...
FROM customers;
"
value2 <- dbGetQuery(con22, query2)
